...
vata-comp:
	#intersection
	./tests-integration/pycobench -c ./tests-integration/jobs/vata-intersection.yaml -t 120 -j 1 < ./tests-integration/inputs/vata-double-tree-long.input -o ./tests-integration/results/vata-intersection.out
	...
	#union
	./tests-integration/pycobench -c ./tests-integration/jobs/vata-union.yaml -t 60 -j 1 < ./tests-integration/inputs/vata-double-tree-long.input -o ./tests-integration/results/vata-union.out
