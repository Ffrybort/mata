...
# note that running all these tests may take several hours or days, adjust the timeout and number of jobs to get a reasonable runtime
# emptiness
	./tests-integration/pycobench -c .tests-integration/jobs/nfta-emptiness.yaml -t 300 -j 1 < ./tests-integration/inputs/nfta-emptiness.input -o ./tests-integration/results/nfta-emptiness.out
	./tests-integration/pyco_proc --csv --param-no 1 ./tests-integration/results/nfta-emptiness.out > ./tests-integration/results/nfta-emptiness.csv
# union nondet
	./tests-integration/pycobench -c ./tests-integration/jobs/nfta-union-nondet.yaml -t 120 -j 1 < ./tests-integration/inputs/double-tree-long.input -o ./tests-integration/results/nfta-union-nondet.out
	./tests-integration/pyco_proc --csv ./tests-integration/results/nfta-union-nondet.out > ./tests-integration/results/nfta-union-nondet.csv
# intersection
...
# union product
	./tests-integration/pycobench -c ./tests-integration/jobs/nfta-union-product.yaml -t 300 -j 1 < ./tests-integration/inputs/double-tree.input -o ./tests-integration/results/nfta-union-product.out
...
# determinisation
	./tests-integration/pycobench -c ./tests-integration/jobs/nfta-determinization.yaml -t 300 -j 1 < ./tests-integration/inputs/single-tree.input -o ./tests-integration/results/nfta-determinization.out
	./tests-integration/pyco_proc --csv ./tests-integration/results/nfta-determinization.out > ./tests-integration/results/nfta-determinization.csv
	./tests-integration/pycobench -c ./tests-integration/jobs/nfta-determinization-naive.yaml -t 300 -j 1 < ./tests-integration/inputs/single-tree.input -o ./tests-integration/results/nfta-determinization-naive.out
	./tests-integration/pyco_proc --csv ./tests-integration/results/nfta-determinization-naive.out > ./tests-integration/results/nfta-determinization-naive.csv
# complementation
	./tests-integration/pycobench -c ./tests-integration/jobs/nfta-complement-classical.yaml -t 300 -j 1 < ./tests-integration/inputs/single-tree.input -o ./tests-integration/results/nfta-complement-classical.out
	./tests-integration/pyco_proc --csv ./tests-integration/results/nfta-complement-classical.out > ./tests-integration/results/nfta-complement-classical.csv
	./tests-integration/pycobench -c ./tests-integration/jobs/nfta-complement-top-down.yaml -t 60 -j 1 < ./tests-integration/inputs/single-tree.input -o ./tests-integration/results/nfta-complement-top-down.out
	./tests-integration/pyco_proc --csv ./tests-integration/results/nfta-complement-top-down.out > ./tests-integration/results/nfta-complement-top-down.csv
#emptiness
	./tests-integration/pycobench -c ./tests-integration/jobs/nfta-emptiness.yaml -t 300 -j 1 < ./tests-integration/inputs/nfta-emptiness.input -o ./tests-integration/results/nfta-emptiness.out
	./tests-integration/pyco_proc --csv ./tests-integration/results/nfta-emptiness.out > ./tests-integration/results/nfta-emptiness.csv
